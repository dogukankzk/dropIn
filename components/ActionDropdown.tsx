    ...
    return (
      <DialogContent className='shad-dialog button '>
        ...
        {["rename", "delete", "share"].includes(value) && (
          <DialogFooter className=' flex flex-col gap-3 w-auto  md:flex-row '>
            <Button className='!modal-cancel-button hover:cursor-pointer' onClick={closeAllModals}>Cancel</Button>
            <Button className='!modal-submit-button hover:cursor-pointer' onClick={handleAction}>
              <p>{value}</p>
               {isLoading && (
                <Image
  ...
  return (
    <Dialog open= {isModalOpen} onOpenChange={setIsModalOpen}>
       <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
            <DropdownMenuTrigger className='shad-no-focus hover:cursor-pointer'>
                <Image  
